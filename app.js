...
app.post('/generate', async (req, res, next) => {
    ...
    return res.json({
        privacy_policy: `
Welcome to ${name} for Android Wear OS! This software is a pay to use Multi-purpose watch face for Wear OS devices. The software was developed using Watch Face Studio released by Samsung. As such, it required more designing than development.
